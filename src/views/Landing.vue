    ...
    <div id="content">
      <div class="jumbotron">
        ...
        <a href="#topics" class="text-dark">
          <svg href="#topics" width="2em" height="2em" viewBox="0 0 16 16" class="bi bi-chevron-double-down" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
